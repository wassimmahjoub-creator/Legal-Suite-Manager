                ...
                <tbody>
                  {inv.lines.map(l => (
                    <tr key={l.id} className="border-b border-border/50">
                      ...
                      <td className="border border-border px-3 py-2 text-left font-mono" dir="ltr"><Money amount={l.unitPriceHt} /></td>
                      <td className="border border-border px-3 py-2 text-left font-mono" dir="ltr">{l.vatRate}%</td>
                      <td className="border border-border px-3 py-2 text-left font-mono font-semibold" dir="ltr"><Money amount={l.lineTotalHt} /></td>
                      <td className="border border-border px-3 py-2 text-left font-mono" dir="ltr"><Money amount={l.lineVat} /></td>
                    </tr>
                  ))}
                  {inv.lines.length === 0 && (
