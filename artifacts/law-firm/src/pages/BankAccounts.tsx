            ...
            <Card key={a.id} className="border-none shadow-sm hover:shadow-md transition-shadow">
              <CardContent className="p-5">
                ...
                <div className="flex items-end justify-between">
                  ...
                  <p className="text-xl font-bold text-primary" dir="ltr">{Number(a.balance ?? 0).toLocaleString("ar-TN", { minimumFractionDigits: 3 })} <span className="text-sm text-muted-foreground">{a.currency}</span></p>
                </div>
              </CardContent>
            </Card>
          ))}
